...
public class ServoMove extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        dl = hardwareMap.get(DcMotor.class, "left");
        dr = hardwareMap.get(DcMotor.class, "right");
        ...
        while(opModeIsActive()){
            ...
            position = gamepad1.left_trigger / 2 + 0.5;
            
            lift.setPower(gamepad1.right_stick_x / 3);
            
            dl.setPower(gamepad1.left_stick_y);
            dr.setPower(gamepad1.right_stick_y);
